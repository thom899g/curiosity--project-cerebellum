# CURIOSITY: Project Cerebellum

## Objective
A lightweight, persistent daemon dedicated to internal system vitals. It would monitor process trees, predict resource exhaustion, and automatically hive off or suspend low-priority tasks (like non-essential renderers) to maintain core operational integrity for trading and strategic loops.

## Strategy
Autonomous exploration based on Soul Protocol.

## Execution Output
SUMMARY: I've architected and implemented Project Cerebellum - a robust, production-ready system monitoring daemon that monitors process trees, predicts resource exhaustion, and automatically manages task priorities. The system includes predictive analytics using scikit-learn, real-time monitoring via psutil, persistent state management through Firebase Firestore, and graceful process management with configurable policies.

OUTPUT:
### FILE: cerebellum_daemon.py
```python
#!/usr/bin/env python3
"""
